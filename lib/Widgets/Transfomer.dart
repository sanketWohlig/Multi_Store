...
class _TransformerPageViewState extends State<TransformerPageView> {
  ...
  void initState() {
    ...
    super.initState();
    pageController = TransformerPageController(itemCount: widget.itemCount);
  }
  ...
  Widget _buildItem(BuildContext context, int index) {
    return AnimatedBuilder(
        ...
        builder: (c, w) {
          int renderIndex =
              pageController!.getRenderIndexFromRealIndex(index);
          Widget? child;
          ...
          double page = pageController!.realPage;
          position = page - index;
          position *= 1;
